...
internal class Distance1RestrictedEditLevenshtomaton<TCaseSensitivity> : Levenshtomaton where TCaseSensitivity : struct, ICaseSensitivity<TCaseSensitivity>
{
    ...
    {
        private static ReadOnlySpan<short> TransitionsD0 => [0x02, -1, -1, -1, -1, -1];
        private static ReadOnlySpan<bool> FinalsD0 => [true, false, true, false, false, false];
        private static ReadOnlySpan<short> TransitionsD1 => [0x01, 0x100, -1, 0x102, -1, 0x102, -1, -1, -1, -1, -1, -1];
        private static ReadOnlySpan<bool> FinalsD1 => [true, true, false, false, false, false];
        private static ReadOnlySpan<short> TransitionsD2 => [0x01, 0x03, 0x100, 0x100, -1, 0x202, 0x102, 0x101, -1, -1, 0x102, 0x102, -1, 0x202, 0x101, 0x101, -1, 0x202, 0x102, 0x101, -1, -1, 0x102, 0x102];
        private static ReadOnlySpan<bool> FinalsD2 => [false, false, false, true, true, true];
        private static ReadOnlySpan<short> TransitionsD3 => [0x01, 0x01, 0x03, 0x03, 0x100, 0x100, 0x100, 0x100, -1, -1, 0x202, 0x202, 0x102, 0x102, 0x101, 0x101, -1, -1, -1, -1, 0x102, 0x102, 0x102, 0x102, -1, 0x302, 0x202, 0x201, 0x101, 0x104, 0x101, 0x104, -1, 0x302, 0x202, 0x201, 0x102, 0x105, 0x101, 0x104, -1, 0x302, -1, 0x302, 0x102, 0x105, 0x102, 0x105];
        private static ReadOnlySpan<bool> FinalsD3 => [false, false, false, false, false, false];
